                                        ...
                                        <TableCell className="px-8 text-right">
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end" className="rounded-xl border-neutral-100 shadow-xl w-48">
                                                    ...
                                                    <DropdownMenuItem className="rounded-lg mx-1 font-bold text-neutral-700">Edit Details</DropdownMenuItem>
                                                    <DropdownMenuItem className="rounded-lg mx-1 font-bold text-neutral-700">Configure Geofence</DropdownMenuItem>
                                                    ...
                                                    <DropdownMenuItem className="rounded-lg mx-1 font-bold text-red-600 focus:text-red-600 focus:bg-red-50">Archive Site</DropdownMenuItem>
                                                </DropdownMenuContent>
                                            </DropdownMenu>
                                        </TableCell>
                                    </TableRow>
